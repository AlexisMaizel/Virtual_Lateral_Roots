...
InitialCellsOfRealData: 121204_raw_2014 // valid entries are:
...
DivisionAreaRatio: 0.12 // 0.145 ... 0.45 threshold of division area ratio in percentage, for example 0.5 means that a cell divides if its initial area has grown by 50%
...
CellPinch: 0.1 // real data point: 5.1, default: 0.75 displacement of the position of the newly inserted vertexes
CellMaxPinch: 0.1 // 1.5 ... 0.1 max displacement of the position of the newly inserted vertexes
