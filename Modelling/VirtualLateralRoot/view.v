[Main]
Dt: 0.1 // 0.0003 // how fast the shape of the end stage is reached, default 0.1
...
SubDivisionLevelOfCells: 15 // this value minus 1 defines the number of additional vertices per cell wall and therefore the subdivision level of a cell
...
DivisionAreaRatio: 0.35 // 0.145 ... 0.45 threshold of division area ratio in percentage, for example 0.5 means that a cell divides if its initial area has grown by 50%
...
CellPinch: 0.155 // real data point: 5.1, default: 0.75 displacement of the position of the newly inserted vertexes
CellMaxPinch: 0.155 // 1.5 ... 0.1 max displacement of the position of the newly inserted vertexes
